...
<nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/Learn-PHP/from_to_database.php" class="flex items-center space-x-3 rtl:space-x-reverse">
...
<form class="max-w-sm mx-auto" action="/Learn-PHP/from_to_database.php" method="post">
    ...
    <button type="reset" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center   mt-2">
